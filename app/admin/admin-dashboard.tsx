...
import type { GuestBookStats, PhotoStory, Tribute } from "@/lib/types";
      ...
      <main className="grid min-h-screen place-items-center bg-cream px-4">
        ...
        >
          ...
          <p className="mt-3 text-sm leading-6 text-smoke">
            This local dashboard reads live Postgres records. Replace the demo passcode with
            production auth before opening admin access publicly.
          </p>
          <input
            value={password}
